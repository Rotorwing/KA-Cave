class Scattering{
     ...
     */
    constructor(scene, camera, light, shadowGenerator){
        ...
        this.depthPassResolution = 0.01; // How far each step along the ray should be
        this.downsample =2.0;
        ...
        if(shadowGenerator){
            ...
            this.shadowMapSize = shadowGenerator.getShadowMap().getSize().width;
        }else{
    ...
    previewDepthPass (){
        ...
        this.camera.attachPostProcess(post_process);
    }
    /**
    ...
    calculateScattering(){
        ...
        const scatteringProcess = new BABYLON.PostProcess('scatteringProcess', 'scattering',
                                                  ...
                                                  ["cameraDepthTexture", "shadowDepthTexture", "lightIntensity"], this.downsample, this.camera, null, engine, true);
        ...
        scatteringProcess.onApply = function (effect) {
            ...
            effect.setFloat2("screenSize", scatteringProcess.width/this.downsample, scatteringProcess.height/this.downsample);
            ...
            effect.setFloat("depthPassResolution", this.depthPassResolution);
        }.bind(this);
