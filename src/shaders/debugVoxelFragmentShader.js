window.debugVoxelFragmentShader = `#version 300 es
...
void main(void) {
    ...
    vec4 xColor = mix(giColors[0], giColors[3], clamp(mixNormal.x, 0., 1.));
    vec4 yColor = mix(giColors[1], giColors[4], clamp(mixNormal.y, 0., 1.));
    vec4 zColor = mix(giColors[2], giColors[5], clamp(mixNormal.z, 0., 1.));
